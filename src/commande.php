   ...
   <body>
      <div>
         ...
         <form class="form" method="post" name="" action="">
            <h1 class="article-title">Commande : </h1>
         ...
         <?php
            ...
            $sqlidcmd = "SELECT id_commande FROM `commande` ORDER BY id_commande DESC LIMIT 1";
               ...
               if($_POST['ajout'] && $_POST['Désignation'] != "" && $_POST['prixunitaire'] != ""){
                          ...
                          $query = "INSERT INTO `ligneCommande`(`id_commande`, `numerounique`, `nomarticle`, `prixarticle`, `quantité`, `Montantligne`) VALUES ('$rowid[id_commande]','$numerounique', '$nomarticle','$prixunitaire', '$quantite','$montant' )";
                          //echo $query;
               ...
               //on calcule la somme du prix de la commande 
                   $queryTotal = "Select SUM(Montantligne) AS TOTAL FROM ligneCommande WHERE id_commande = '$rowid[id_commande]'";
                          //echo $query;
                   ...
                   //on update le prix du montant de la commande   dans la table commande 
                    $sqlupdate = "UPDATE `commande` SET MontantCommande='$rowTotal[TOTAL]' WHERE id_commande=$rowid[id_commande]";
                       //echo $sqlupdate;
            ...
            <table border="3">
               ...
               <tbody>
                  <?php 
                     ...
                     $sql = "SELECT * FROM `ligneCommande` Where id_commande ='$rowid[id_commande]'";
                     //echo $sql;
         ...
         <h2 style="color: red; font-weight: bold;">
            <?php 
               ...
               if($_POST['payer'] && $rowTotal[TOTAL]!=""){
                   echo "<script type='text/javascript'>window.top.location='reglementcommande.php';</script>";
               }
